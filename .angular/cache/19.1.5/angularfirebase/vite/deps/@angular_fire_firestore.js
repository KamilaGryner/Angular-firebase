...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  ...
  setDatabaseDeletedListener(e) {
    this.mi.B((t) => __async(this, null, function* () {
...
function __PRIVATE_ensureWriteStream(e) {
  ...
  (e.G_ = function __PRIVATE_newPersistentWriteStream(e2, t, n) {
    ...
    yield __PRIVATE_fillWritePipeline(e)) : (yield e.G_.stop(), e.B_.length > 0 && (__PRIVATE_logDebug("RemoteStore", `Stopping write stream with ${e.B_.length} pending writes`), e.B_ = []));
  }))), e.G_;
}
